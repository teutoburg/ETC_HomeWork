...
def _get_noise(target_counts, sky_counts_pp, dit):
    ...
    #     or a seeing of 0.8 arcsec FWHM, which is described as the 50% value.
...
def signal_to_noise(target_counts, sky_counts_pp, dit, n_dit):
    """
    Calculate the S/N ratio for given target and sky counts and exposure time.
    ...
    noise = _get_noise(target_counts, sky_counts_pp, dit)
...
def create_sky(pixel_scale, dit, **kwargs):
    """
